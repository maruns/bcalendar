...
<div style="position:relative"><div id="divLogo"><a href="http://www.bluedental.pl/" target="_blank"><img src="{logo_file}" border="0" title="Przejdź na stronę główną witryny Blue Dental" alt="Blue Dental"/></a></div></div>
