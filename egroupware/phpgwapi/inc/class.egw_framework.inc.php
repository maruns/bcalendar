 ...
 * @access public
 * @version $Id: class.egw_framework.inc.php 38786 2012-04-04 13:58:16Z ralfbecker $
 */
...
abstract class egw_framework
{
	...
	*/
	...
	public function _get_css()
	{
		...
		{
                        if ($GLOBALS['bcalendarIsCurrent']) //jeśli bcalendar jest bieżący, używaj jego plików
                        {
                            $appname = 'bcalendar';
                        }
                        else
