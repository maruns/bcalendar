 ...
 */
class bcalendar_rrule implements Iterator
{
	/**
	 * No recurrence
	 */
	...
	public static function event2rrule(array $event,$usertime=true,$to_tz=null)
	{
		...
		return new bcalendar_rrule($time,$event['recur_type'],$event['recur_interval'],$enddate,$event['recur_data'],$exceptions);
	}
...
if (isset($_SERVER['SCRIPT_FILENAME']) && $_SERVER['SCRIPT_FILENAME'] == __FILE__)	// some tests
{
	...
	$rrule = new bcalendar_rrule($time,$_REQUEST['type'],$_REQUEST['interval'],$enddate,$weekdays,$exceptions);
